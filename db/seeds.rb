...
Movie.create(title: "Jurassic Park", overview: "A pragmatic Paleontologist visiting an almost complete theme park is tasked with protecting a couple of kids after a power failure causes the park's cloned dinosaurs to run loose.", poster_url: "https://image.tmdb.org/t/p/original/eB1oI9ebdCcUFZrP3zQkbP8osXK.jpg", rating: 8.1)
Movie.create(title: "Avatar", overview: "A paraplegic Marine dispatched to the moon Pandora on a unique mission becomes torn between following his orders and protecting the world he feels is his home.", poster_url: "https://image.tmdb.org/t/p/original/kmcqlZGaSh20zpTbuoF0Cdn07dT.jpg", rating: 7.8)
